        ...
        <div class="container">
            ...
            <div class="pb-md-3">
                <div class="login-wrap">
                        ...
                        <div class="login-form">
                            ...
                            <form method="post" action="Sign.php">
                                <div class="sign-in-htm">
                                    ...
                                    <? echo $error; ?>
                                    <div class="group">
                                            <input type="submit" class="button" value="一般登入">
					...
					<input id="Password" type="password" minlength="6" placeholder="至少六位數以上英數字組合" required pattern="(?=^[A-Za-z0-9]{6,999}$)((2=.*[a-z])(2=.*[0-9]))^.*$" class="input" data-type="password" required="required">
				</div>--->
                                    <div class="group">
                                    ...
                                    <div class="group">
                                        <input type="submit" class="button" value="註冊成功">
                                    </div>
                                </div>
                                </table>
                            </form>
